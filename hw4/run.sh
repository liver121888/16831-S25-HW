# Q1
# python rob831/hw4_part1/scripts/run_hw4_mb.py --exp_name q1_cheetah_n500_arch1x32 --env_name cheetah-hw4_part1-v0 --add_sl_noise --n_iter 1 --batch_size_initial 20000 --num_agent_train_steps_per_iter 500 --n_layers 1 --size 32
...
# Q6
# python rob831/hw4_part2/scripts/run_hw4_expl.py --env_name PointmassEasy-v0 --use_rnd --unsupervised_exploration --exp_name q6_env1_rnd
# python rob831/hw4_part2/scripts/run_hw4_expl.py --env_name PointmassEasy-v0 --unsupervised_exploration --exp_name q6_env1_random
# python rob831/hw4_part2/scripts/run_hw4_expl.py --env_name PointmassHard-v0 --use_rnd --unsupervised_exploration --exp_name q6_env2_rnd
# python rob831/hw4_part2/scripts/run_hw4_expl.py --env_name PointmassHard-v0 --unsupervised_exploration --exp_name q6_env2_random
